				...
				>
					<Modal remove={!isActive} ref={modalRef}>
						...
						<StyledSimpleBar style={{ maxHeight: 300 }}>
							...
							{errorCode === 1 && (
								<>
									<ErrorMessageLine>
										Please install or unlock MetaMask
										and reload the page.
										<div>
											<ExternalLink
							...
							{errorCode === 2 && (
								<>
									<ErrorMessageLine>
										Use your injected wallet to authorize
					...
					{alertIsVisible && (
						<Alert remove={!alert.isActive} ref={alertRef}>
							<Title>Wallet Attention</Title>
							<Content>
								Wallet connection needs attention.
								<br />
								Please reconnect your injected wallet and try again.
								<br />
								You will need native gas tokens on chain `13939`
