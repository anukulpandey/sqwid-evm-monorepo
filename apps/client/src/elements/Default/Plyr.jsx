...
import PlyrJS from "plyr/dist/plyr.js";
...
export const Plyr = React.forwardRef((props, ref) => {
	const { options = null, source } = props,
		rest = __rest(props, ["options", "source"]);
	...
	useEffect(() => {
		...
		if (
			...
			innerRef.current.plyr = new PlyrJS(
				".plyr-react",
	...
	return React.createElement(
		"video",
		Object.assign({ ref: innerRef, className: "plyr-react plyr" }, rest)
	);
});
