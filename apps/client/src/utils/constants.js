const constants = {
	...
	APP_ABOUT:
		"%APP_NAME% seeks to create a safe and accessible environment where artists can distribute their work on the configured EVM network and forge closer bonds with their followers.",
	...
	COPY_WARNING: "Use this address only on the configured Sqwid network",
	OCEAN_QUOTES: [
