...
describe("************ Governance ******************", () => {
    before(async () => {
        ...
        iniOwner = signers.account1;
        owner1 = signers.account2;
        owner2 = signers.account3;
        owner3 = signers.account4;
        user1 = signers.account3;
        user2 = signers.account4;
        ...
        const Governance = await ethers.getContractFactory("SqwidGovernance", iniOwner);
